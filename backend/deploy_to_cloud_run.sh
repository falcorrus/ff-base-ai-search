...
gcloud run deploy $IMAGE_NAME \
  ...
  --set-env-vars GOOGLE_API_KEY=$GOOGLE_API_KEY,LOG_LEVEL=$LOG_LEVEL,GITHUB_PAT=$GITHUB_PAT,GITHUB_REPO_OWNER=$GITHUB_REPO_OWNER,GITHUB_REPO_NAME=$GITHUB_REPO_NAME,GCS_BUCKET_NAME=$GCS_BUCKET_NAME
