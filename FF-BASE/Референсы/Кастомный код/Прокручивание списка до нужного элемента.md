От: @krv4art
Источник: https://t.me/flutterflow_rus/24030/55624

При клике на любой контент слева, происходит изменение PageState переменной которая передается в виджет, а тот в свою очередь прокручивает список до нужного элемента и выделяет его рамочкой.

![[../temp/image_Прокручивание списка до нужного элемента_.txt]]
